...
async function get<Response = object>(url: string, token?: string): Promise<Response> {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
async function post<Response = object>(url: string, payload: any, token?: string): Promise<Response> {
